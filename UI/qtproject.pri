...
INCLUDEPATH += \
    $$IDE_BUILD_TREE/lib \ # for <app/app_version.h> in case of actual build directory
    $$IDE_SOURCE_TREE/lib \ # for <app/app_version.h> in case of binary package with dev package
    $$IDE_SOURCE_TREE/lib/libs \
...
QTC_PLUGIN_DIRS += $$IDE_SOURCE_TREE/lib/plugins
!isEqual($$IDE_SOURCE_TREE, $$QTCANPOOL_DIR) {
    QTC_PLUGIN_DIRS += $$QTCANPOOL_DIR/lib/plugins
}
...
QTC_LIB_DIRS += $$IDE_SOURCE_TREE/lib/libs
!isEqual($$IDE_SOURCE_TREE, $$QTCANPOOL_DIR) {
    QTC_LIB_DIRS += $$QTCANPOOL_DIR/lib/libs
}
