...
void OlsMainWindow::createCentralWidget()
{
    ...
    QLabel *label = new QLabel("Designer It By Yourself");
...
//    QAction *action = new QAction(QIcon(":/main/design.png"), tr("Design"));
...
//    tabBar->addActionButton(button, FancyTabBar::Back);

//    QAction *action = new QAction(QIcon(":/main/design.png"), tr("action2"));
//    tabBar->addAction(action, FancyTabBar::Middle);
//    tabBar->setActionIconOnly(action, false);

    tabBar->addAction(QIcon(":/tools/start"), tr("start"));
    tabBar->addAction(QIcon(":/tools/suspend"), tr("suspend"));
    QAction * action = tabBar->addAction(QIcon(":/tools/stop"), tr("stop"));
