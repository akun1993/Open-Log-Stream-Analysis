...
#add_library(ols-version STATIC EXCLUDE_FROM_ALL)
#add_library(OLS::ols-version ALIAS ols-version)
# cmake-format: on
#configure_file(olsversion.c.in olsversion.c @ONLY)
#target_sources(ols-version PRIVATE olsversion.c olsversion.h)
#target_include_directories(ols-version PUBLIC ${CMAKE_CURRENT_SOURCE_DIR})
#set_property(TARGET ols-version PROPERTY FOLDER core)
#set_target_properties(ols-version PROPERTIES LINKER_LANGUAGE C)
