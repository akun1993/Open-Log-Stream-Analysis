...
set_source_files_properties(
  olspython.i PROPERTIES USE_TARGET_INCLUDE_DIRECTORIES TRUE
...
set_target_properties(olspython PROPERTIES SWIG_COMPILE_DEFINITIONS "${_SWIG_DEFINITIONS}")

if(OS_WINDOWS)
  set_target_properties(olspython PROPERTIES SWIG_COMPILE_DEFINITIONS "${_SWIG_DEFINITIONS};MS_NO_COREDLL")
...
elseif(OS_MACOS)
  ...
  target_compile_options(olspython PRIVATE -Wno-unused-parameter -Wno-error=macro-redefined)
  ...
  set_target_properties(olspython PROPERTIES MACHO_CURRENT_VERSION 0 MACHO_COMPATIBILITY_VERSION 0)
elseif(OS_POSIX)
  target_link_libraries(olspython PRIVATE Python::Python)
