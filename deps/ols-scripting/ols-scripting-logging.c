...
void script_log_va(ols_script_t *script, int level, const char *format,
		   va_list args)
{
	char msg[2048];
...
void script_log(ols_script_t *script, int level, const char *format, ...)
{
	va_list args;
...
void ols_scripting_set_log_callback(scripting_log_handler_t handler,
				    void *log_param)
{
	callback = handler;
	param = log_param;
