...
set(CMAKE_XCODE_ATTRIBUTE_CURRENT_PROJECT_VERSION ${OLS_BUILD_NUMBER})
set(CMAKE_XCODE_ATTRIBUTE_DYLIB_COMPATIBILITY_VERSION 1.0.0)
set(CMAKE_XCODE_ATTRIBUTE_MARKETING_VERSION ${OLS_VERSION_CANONICAL})

# Set deployment target
set(CMAKE_XCODE_ATTRIBUTE_MACOSX_DEPLOYMENT_TARGET ${CMAKE_OSX_DEPLOYMENT_TARGET})

if(NOT OLS_PROVISIONING_PROFILE)
  set(OLS_PROVISIONING_PROFILE
      ""
      CACHE STRING "OLS provisioning profile name for macOS" FORCE)
else()
  set(CMAKE_XCODE_ATTRIBUTE_PROVISIONING_PROFILE_NAME "${OLS_PROVISIONING_PROFILE}")
endif()

if(NOT OLS_CODESIGN_TEAM)
  # Switch to manual codesigning if no codesigning team is provided
  set(CMAKE_XCODE_ATTRIBUTE_CODE_SIGN_STYLE Manual)
  set(CMAKE_XCODE_ATTRIBUTE_CODE_SIGN_IDENTITY "${OLS_CODESIGN_IDENTITY}")
else()
  if(OLS_CODESIGN_IDENTITY AND NOT OLS_CODESIGN_IDENTITY STREQUAL "-")
  ...
  set(CMAKE_XCODE_ATTRIBUTE_DEVELOPMENT_TEAM "${OLS_CODESIGN_TEAM}")
endif()
...
# Disable using ARC in ObjC by default (OLS does not support this - yet)
