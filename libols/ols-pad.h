...
#define OLS_PAD_STREAM_LOCK(pad) \
  (pthread_mutex_lock(OLS_PAD_GET_STREAM_LOCK(pad)))
#define OLS_PAD_STREAM_UNLOCK(pad) \
  (pthread_mutex_unlock(OLS_PAD_GET_STREAM_LOCK(pad)))
